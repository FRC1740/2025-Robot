...
public class ElevatorConstants {
    ...
    public static final double kFFDeadband = 0.02; // zone which error is acceptable, .1in both ways
    ...
    public static final double k4HalvingOffset = 27; // height the elevator must pass (dont care in stow)
