...
public class ElevatorCommandConstants {
    ...
    public static ElevatorPose L2Score = new ElevatorPose(-4, 0.2);
    public static ElevatorPose L3Score = new ElevatorPose(-12, 0.2);
    ...
    public static ElevatorPose Intake = new ElevatorPose(-4.8, .09);
